...
public class GanXiZhuXingBiao {
	...
	public static int[] tianFuBiao =  {9,8,0,11,3,2,6,5,6,5};
	public static int[] tianChuBiao = {5,6,0,5,6,8,2,6,9,11};
	public static int[] jieKongBiao1 = {8,6,4,2,0,8,6,4,2,0};
	public static int[] jieKongBiao2 = {9,7,5,3,1,9,7,5,3,1};
}
